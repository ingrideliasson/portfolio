    ...
    return(
        <div className="flex flex-col">
            ...
            <div className="grid sm:gap-8 gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 sm:px-8 lg:p-12 lg:px-48">
                ...
                <ProjectCard
                    image={`${process.env.PUBLIC_URL}/images/cv-project.png`}
                    title="CV-template"
                ...
                <ProjectCard
                    image={`${process.env.PUBLIC_URL}/images/macaron-project.png`}
                ...
                <ProjectCard
                    image={`${process.env.PUBLIC_URL}/images/travelsite.png`}
                    title="Wanderlust"
                ...
                <ProjectCard
                    image={`${process.env.PUBLIC_URL}/images/assettracker-project.png`}
                    title="Asset Tracker"
